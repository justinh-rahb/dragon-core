...
void app_main(void)
{
    ...
    dc_pid_config_t pid_config = {
        .output_min = 0.0f,
        .output_max = 1.0f,
        .integral_min = 0.0f,
        .integral_max = 0.0f,
    };
    dc_pid_state_t pid_state = {0};
    dc_pid_result_t pid_result = {0};
    ...
    dc_pid_reset(&pid_state);
    (void)dc_pid_step(&pid_state, &pid_config,
                      0.0f, 0.0f, 1.0f, false, &pid_result);
